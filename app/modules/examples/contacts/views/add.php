...
<form id="add-contact-form" class="form-horizontal" method="post"
    ...
    <div class="clearfix field-firstname required <?php echo $model->hasError('firstname') ? 'has-error' : '' ?>">
        <div class="form-group form-group-lg">
            <div class="col-sm-12">
                <input class="form-control" type="text" name="<?php echo $model->fieldName("firstname") ?>"
    ...
    <div class="clearfix field-lastname required <?php echo $model->hasError('lastname') ? 'has-error' : '' ?>">
        <div class="form-group form-group-lg">
            <div class="col-sm-12">
                <input class="form-control" type="text" name="<?php echo $model->fieldName("lastname") ?>"
    ...
    <div class="clearfix field-email required <?php echo $model->hasError('email') ? 'has-error' : '' ?>">
        <div class="form-group form-group-lg">
            <div class="col-sm-12">
                <input class="form-control" type="text" name="<?php echo $model->fieldName("email") ?>"
    ...
    <div class="clearfix field-address required <?php echo $model->hasError('address') ? 'has-error' : '' ?>">
        <div class="form-group form-group-lg">
            <div class="col-sm-12">
                <input class="form-control" type="text" name="<?php echo $model->fieldName("address") ?>"
    ...
    <div class="clearfix field-phone required <?php echo $model->hasError('phone') ? 'has-error' : '' ?>">
        <div class="form-group form-group-lg">
            <div class="col-sm-12">
                <input class="form-control" type="text" name="<?php echo $model->fieldName("phone") ?>"
